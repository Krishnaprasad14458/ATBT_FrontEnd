...
//               </div> */}
//               <div className=''>
//                 <button className="mt-4 flex w-full justify-center rounded-md bg-orange-600 px-3 py-1.5 text-sm leading-6 text-white shadow-sm  focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-orange-600">
//                   Create User
//                 </button>
//               </div>
//             </form>
...
//                       </svg>
//                     </div>
//                     <p className="text-md text-gray-800 mt-1 ms-3">{userDetails.phone}</p>
//                   </div>
...
//                       </svg>
//                     </div>
//                     <p className="text-md text-gray-800 mt-1 ms-3">{userDetails.email}</p>
//                   </div>
...
//                       </svg>
//                     </div>
//                     <p className="text-md text-gray-800 mt-1 ms-3">{userDetails.EntityName}</p>
//                   </div>
...
//                       </svg>
//                     </div>
//                     <p className="text-md text-gray-800 mt-1 ms-3"> {userDetails.Designation}</p>
//                   </div>
//                 </div>
//               </div>
//             </div>
                  ...
                  {item.type === 'text' && item.inputname == "name" && item.field === "predefined" && (
                    <div>
                      ...
                      <input
                        ...
                        className="p-2 block w-full rounded-md bg-gray-50 border-2 border-gray-200 text-gray-900 text-xs appearance-none shadow-sm placeholder:text-gray-400 focus:outline-none focus:border-orange-400 sm:text-sm 
                        placeholder:text-xs"
                  ...
                  {item.type === 'email' && item.inputname == "email" && item.field == "predefined" && (
                    <div>
                      ...
                      <input
                        ...
                        className="p-2 block w-full rounded-md bg-gray-50 border-2 border-gray-200  text-xs text-gray-900 appearance-none shadow-sm placeholder:text-gray-400 focus:outline-none focus:border-orange-400 sm:text-sm  placeholder:text-xs"
                        onChange={(e) => handleChange(index, e.target.value)}
                      />
                    </div>
                  )}
                  ...
                  {item.type === 'select' && item.inputname == "entityname" && item.field == "predefined" && (
                    <div>
                      ...
                      <select
                        id={item.inputname}
                        name={item.inputname}
                        className="p-2 block w-full rounded-md bg-gray-50 border-2 border-gray-200  text-xs text-gray-900  shadow-sm placeholder:text-gray-400 focus:outline-none focus:border-orange-400 sm:text-sm sm:leading-6 placeholder:text-xs"
                        onChange={(e) => handleChange(index, e.target.value)}
                        value={customFormFields[index].value || ''}
                  ...
                  {item.type === 'select' && item.inputname == "designation" && item.field == "predefined" && (
                    <div>
                      ...
                      <select
                        id={item.inputname}
                        name={item.inputname}
                        className="p-2 block w-full rounded-md bg-gray-50 border-2 border-gray-200  text-xs text-gray-900  shadow-sm placeholder:text-gray-400 focus:outline-none focus:border-orange-400 sm:text-sm placeholder:text-xs"
                        onChange={(e) => handleChange(index, e.target.value)}
                        value={customFormFields[index].value || ''}
                      ><option value="">--select--</option>
                        {item.options && item.options.map((option, index) => (
                  ...
                  {item.type === 'text' && item.field == "custom" && (
                    <div>
                      ...
                      <input
                        ...
                        // value={formData[item.label] || ''}
                        value={customFormFields[index].value || ''}
                        className="p-2 block w-full rounded-md bg-gray-50 border-2 border-gray-200 py-1 text-gray-900 appearance-none shadow-sm placeholder:text-gray-400 focus:outline-none focus:border-orange-400 sm:text-sm "
                        onChange={(e) => handleChange(index, e.target.value)}
                      />
                    </div>
                  )}
