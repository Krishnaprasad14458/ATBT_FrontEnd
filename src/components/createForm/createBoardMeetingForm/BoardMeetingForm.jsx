  ...
  <div className='container p-3 bg-[#f8fafc] '>
    <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3 xl:grid-cols-3 gap-4">
      <div className="col-span-1 p-3">
        ...
        <form className="space-y-4 mt-2" method="POST">
          ...
          <div className="max-w-md mx-auto">
            <label for="datepicker" className="block text-sm font-medium text-gray-700">Select a Date:</label>
            <input type="date" id="datepicker" name="datepicker" className="p-3 block w-full rounded-md border border-1 border-gray-400 py-1.5 text-gray-900 appearance-none shadow-sm  placeholder:text-gray-400 focus:outline-none focus:border-orange-400 sm:text-sm sm:leading-6" />
          </div>

          <div className="max-w-md mx-auto">
            <label for="timepicker" className="block text-sm font-medium text-gray-700">Select a Time:</label>
            <input type="time" id="timepicker" name="timepicker" className="p-3 block w-full rounded-md border border-1 border-gray-400 py-1.5 text-gray-900 appearance-none shadow-sm  placeholder:text-gray-400 focus:outline-none focus:border-orange-400 sm:text-sm sm:leading-6" />
          </div>
          <div>
          ...
          <div>
            ...
            <div className=''>
              <textarea className="resize-none border rounded-md p-2 w-full h-16 border-1 border-gray-400 focus:outline-none focus:border-orange-400"></textarea>
            </div>
          </div>
          <div>
      ...
      <div className="col-span-2 p-3">
        <div className="rounded-md overflow-hidden shadow-md h-screen">
          <div className="p-4">
