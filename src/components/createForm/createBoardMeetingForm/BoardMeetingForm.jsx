                  ...
                  {item.type === 'multiselect' &&
                    ...
                    item.field == 'predefined' && (
                      <div className='relative'>
                        <label
                          htmlFor='email'
                          className='block text-sm mt-1 font-medium leading-6 text-gray-900'
                        >
                          {item.label}
                        </label>
                        ...
                        <div className='w-1/2'>
                          {item.value ? (
                            ...
                            <span className='text-xs text-gray-400 '>
                              Venue :a house pista house pista house pista house
                              v pista house ouse v pista house ouse v pista
                              house
                            </span>
                          )}
                        </div>
