            ...
            <div className="grid grid-cols-1 sm:grid-cols-1 md:grid-cols-1 lg:grid-cols-3 xl:grid-cols-3  gap-4 mt-2 ">
                <div className="col-span-1 ">
                    <form className=" " method="POST" onSubmit={handleFormSubmit} >
                                    ...
                                    {item.type === 'range' && item.field == "custom" && (
                                        <div>
                                            ...
                                            <input
                                                ...
                                                value={customFormFields[index].value || ''}
                                                onChange={(e) => handleChange(index, e.target.value)} />
                                            <div className='h-2 text-[#dc2626]'>{errors[item.inputname] && <span>{errors[item.inputname]}</span>}
                                            </div>
                                        </div>
                                    )}
                        ...
                        <div className=''>
                            <button type="submit"
                                className="mt-6 flex w-full justify-center rounded-md bg-orange-600 px-3 py-2.5 text-sm font-medium leading-6 text-white shadow-sm  focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-orange-600">Create Team</button>
                        </div>
                    </form>
                </div>
                {/* preview */}
                <div className=' col-span-2 hidden sm:block md:block shadow-md px-6 py-4 mt-4 border-2 rounded-md bg-[#f8fafc] '>
                    {customFormFields && customFormFields.length > 0 && customFormFields.map((item) => (
                        <div className='relative' >
                            ...
                            {item.type === 'text' && item.inputname == "name" && item.field === "predefined" && (
                                <div>
                                    {item.value ? (
                                        <p className='text-sm font-black text-gray-800 mt-2 absolute left-12'> {item.value.toUpperCase()}</p>
                                    ) : (
                                        <p className='text-sm font-black text-gray-800 mt-2 absolute left-12'> ENTITY NAME</p>
                                    )}
                                </div>
                            )}
                            {item.type === 'file' && item.inputname == "image" && item.field == "predefined" && (
                            ...
                            {item.type === "date" && item.field == "custom" && <div className='my-2 ms-2'>
                                {item.value && item.value.length > 0 &&
                                    <p className='flex flex-wrap gap-2'>
                                        <span className=' w-1/6 text-[#727a85]'>{item.label.charAt(0).toUpperCase() + item.label.slice(1)}</span>
                                        <span className=' w-4/6 text-md font-[600]'> : {item.value}</span>
                            ...
                            {item.type === "select" && item.field == "custom" && <div className='my-2 ms-2'>
                                {item.value && item.value.length > 0 &&
                                    <p className='flex flex-wrap gap-2'>
                                        <span className=' w-1/6 text-[#727a85]'>{item.label.charAt(0).toUpperCase() + item.label.slice(1)}</span>
                                        <span className=' w-4/6 text-md font-[600]'> : {item.value}</span>
                            ...
                            {item.type === "checkbox" && item.field == "custom" && <div className='my-2 ms-2'>
                                {item.value && item.value.length > 0 &&
                                    <p className='flex flex-wrap gap-2'>
                                        <span className=' w-1/6 text-[#727a85]'>{item.label.charAt(0).toUpperCase() + item.label.slice(1)}</span>
                            ...
                            {item.type === "range" && item.field == "custom" && <div className='my-2 ms-2'>
                                {item.value && item.value.length > 0 &&
                                    <p className='flex flex-wrap gap-2'>
                                        <span className=' w-1/6 text-[#727a85]'>{item.label.charAt(0).toUpperCase() + item.label.slice(1)}</span>
                                        <span className=' w-4/6 text-md font-[600]'> : {item.value}</span>
                            ...
                            {item.type === "time" && item.field == "custom" && <div className='my-2 ms-2'>
                                {item.value && item.value.length > 0 &&
                                    <p className='flex flex-wrap gap-2'>
                                        <span className=' w-1/6 text-[#727a85]'>{item.label.charAt(0).toUpperCase() + item.label.slice(1)}</span>
                                        <span className=' w-4/6 text-md font-[600]'> : {item.value}</span>
