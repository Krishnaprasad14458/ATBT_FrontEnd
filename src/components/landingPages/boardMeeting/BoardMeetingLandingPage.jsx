        ...
        <table className="w-full border-collapse border border-slate-200 mt-1 table-auto">
          <thead>
            <tr >
              ...
              <th scope="col" className="py-2 text-sm text-white bg-orange-600   border-collapse border border-[#e5e7eb]">Entity</th>
          ...
          <tbody className="divide-y divide-gray-200 dark:divide-gray-700">
            <tr className='text-center text-gray-500'>
              ...
              <td scope="col" className="py-2 text-sm border-collapse border border-[#e5e7eb]">Entity</td>
