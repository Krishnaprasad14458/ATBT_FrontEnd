        ...
        <div>
            <div className="flex justify-center items-center min-h-screen">
                <div className="border-2 border-gray-100 px-10 py-2 sm:px-20 sm:py-5 md:px-40 md:py-10 shadow-md  rounded-md">
                    ...
                    <div className="text-4xl sm:text-6xl md:text-8xl text-center text-orange-600 font-light mt-1 sm:mt-3 md:mt-5">403</div>
                    <div className="text- sm:text-2xl md:text-3xl text-center text-orange-600  sm:mt-1 md:mt-3">Access to this page restricted</div>
                    <div className="text-sm sm:text-md md:text-md text-center text-orange-600  sm:mt-1 md:mt-2">Please check with the site admin if you believe this is a mistake</div>
                    <div className="flex justify-center mt-3 sm:mt-4 md:mt-6">
                        <button className="border border-1 border-gray-100 px-4 py-2 sm:px-6 sm:py-3 md:px-8 md:py-4 bg-orange-600 text-white rounded-md" >Go Back Home</button>
                    </div>
                </div>
            </div>
        </div>
