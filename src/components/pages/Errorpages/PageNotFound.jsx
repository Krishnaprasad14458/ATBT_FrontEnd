      ...
      <div className="relative flex justify-center items-center min-h-screen">
        <div className="border-2 border-gray-100 px-10 py-2 sm:px-20 sm:py-5 md:px-40 md:py-10 shadow-lg">
          ...
          <div className="flex justify-center mt-5 sm:mt-8 md:mt-10">
            <button className="border border-1 border-gray-100 px-4 py-2 sm:px-6 sm:py-3 md:px-6 md:py-2 text-sm bg-orange-600 text-white rounded-md" onClick={() => navigate("/")}>Back to Home</button>
          </div>
        </div>
      </div>
    </main>
