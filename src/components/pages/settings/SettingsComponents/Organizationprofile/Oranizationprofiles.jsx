                        ...
                        <table className="min-w-full divide-y divide-gray-200 dark:divide-gray-700 border-collapse border border-[#e5e7eb] rounded-md ">
                            ...
                            <tbody className="divide-y divide-gray-200 dark:divide-gray-700">
                                ...
                                <tr className="hover:bg-gray-100 dark:hover:bg-gray-700">
                                    ...
                                    <td className="px-6 py-2.5 whitespace-nowrap text-center  text-xs font-medium text-gray-800 border-collapse border border-[#e5e7eb]">kapil@gmail.com</td>
                                    <td className="px-6 py-2.5 whitespace-nowrap text-center  text-xs font-medium text-gray-800 border-collapse border border-[#e5e7eb]">9871230926</td>
