...
const UsersFormDup = () => {
  ...
  const handleSubmitCustomForm = () => {
    ...
    axios
      .put(`https://atbtmain.teksacademy.com/form/update`, formData)
      .then((response) => {
      ...
      <div className='flex justify-between'>
        ...
        <div className='flex justify-end'>
          <button
            ...
            className='create-btn px-3 py-2 inline-flex items-center justify-center whitespace-nowrap rounded-full text-sm font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 bg-orange-600 text-primary-foreground shadow hover:bg-primary/90 shrink-0 text-white gap-1'
          >
            + Add Field
          </button>
        </div>
                ...
                {input.inputname == selected && (
                  <div class='px-6'>
                        ...
                        <div class='w-full relative m-0 '>
                          <div class='w-full'>
                            <input
                              ...
                              class='input-mol  p-[0.5rem]   w-full text-darkSlate01 text-sm rounded focus:outline-none bg-[#f8fafc] focus:shadow-none border border-slate04 focus:border-slate01!rounded-none py-3 !text-body px-4  undefined'
                              value={
                                input.label.charAt(0).toUpperCase() +
                                input.label.slice(1)
                              }
                    ...
                    <div class='flex justify-end w-full  pb-2'>
                      ...
                      <div class=''>
                        <button
                          class=' flex w-full justify-center rounded-md bg-orange-600 px-3 py-2.5 text-sm font-medium leading-6 text-white shadow-sm  focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-orange-600
                        ...
                        {(newInputField.type === 'select' ||
                          ...
                          <div>
                            ...
                            <div className='flex '>
                              <label
                                htmlFor='venue'
                                className='block text-sm font-medium leading-6 mt-3 mb-2  ms-2 text-gray-900 '
                              >
                                Option{' '}
                              </label>
                              <div>
                            ...
                            <div className='ps-2 py-2'>
                              {' '}
                              {newInputField.options &&
                                newInputField.options.length > 0 && (
                                  <div
                                    class=' border border-1 w-[360px] border-gray-200 mb-3  ps-1 py-1 rounded-md gap-2 flex flex-wrap overflow-y-auto'
                                    style={{ maxHeight: '100px' }}
                                  >
                                    {newInputField.options.map(
                                      (option, index) => (
                                        <span
                                          key={index}
