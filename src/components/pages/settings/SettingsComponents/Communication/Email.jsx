  ...
  return (
    <div className='p-4'>
      <div className='flex justify-between'>
        ...
        <button type="submit"
          className="rounded-md bg-orange-600 px-8 py-1.5 text-sm leading-6 text-white shadow-sm hover:bg-orange-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-orange-600"><Link to="/editemailtemplate">Add Email Templates</Link></button>
      </div>
