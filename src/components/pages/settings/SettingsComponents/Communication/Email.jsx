  ...
  return (
    <div className='p-3'>
      ...
      <div className='flex justify-between my-2'>
        ...
        <button type="submit"
          className="rounded-md bg-orange-600 px-8 py-1.5 text-sm leading-6 text-white shadow-sm hover:bg-orange-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-orange-600">Add Email Templates</button>
      </div>
      <form className="space-y-6 p-2" method="POST">
        ...
        <div className="grid grid-cols-2 gap-4">
          ...
          <div className="flex items-center relative ms-2">
            <label htmlFor="variables" className="text-sm font-medium text-gray-900 mr-2">Insert&nbsp;Variables:</label>
            <select class="p-3 block w-full rounded-md border border-1 border-gray-400 py-1.5 text-gray-900 bg-gray-100  appearance-none shadow-sm  placeholder:text-gray-400 focus:outline-none focus:border-orange-400 sm:text-sm sm:leading-6">
