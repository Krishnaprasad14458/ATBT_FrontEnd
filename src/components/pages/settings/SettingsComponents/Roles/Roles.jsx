            ...
            <tbody className='divide-y divide-gray-200 dark:divide-gray-700'>
              {data?.roles?.map((role) => (
                ...
                >
                  ...
                  <td className='px-6 py-2 whitespace-nowrap text-left text-xs font-medium text-gray-800 border-collapse border border-[#e5e7eb] overflow-hidden' style={{ maxWidth: '160px' }}>
