        ...
        <div className='grid grid-cols-1 sm:grid-cols-1 md:grid-cols-1 lg:grid-cols-3 xl:grid-col-3 gap-2 mt-2'>
          ...
          <div className='grid1-item text-end md:flex md:justify-end filter_pagination'>
            ...
            <div
              ...
              style={{ transition: 'opacity 0.3s ease-in-out' }}>
              <div
                className='fixed inset-y-0 right-0 w-11/12 md:w-4/12 lg:w-1/5 xl:w-w-1/5   bg-white shadow-lg transform translate-x-full transition-transform duration-300 ease-in-out  overflow-auto'
                style={{
                  transform: `translateX(${filterDrawerOpen ? '0%' : '100%'})`,
                  transition: 'transform 0.3s ease-in-out',
                }}>
                <div className='flex justify-between px-5 py-4 bg-gray-100  top-0 sticky z-[3]'>
                ...
                <hr className='h-1 w-full' />
                <div className='px-2 py-1  flex-wrap h-full'>
                ...
                <div className='bg-gray-100 flex justify-between px-3 pt-2 pb-1 w-full sticky bottom-0'>
                  <button
