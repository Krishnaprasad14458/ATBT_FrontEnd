            ...
            <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700 border-collapse border border-[#e5e7eb] rounded-md ">
              <thead>
                <tr>
                  ...
                  <th scope="col" class="px-6 py-2 text-center text-sm  text-white bg-orange-600   border-collapse border border-[#e5e7eb]">Entity Completed</th>
                  <th scope="col" class="px-6 py-2 text-center text-sm  text-white bg-orange-600   border-collapse border border-[#e5e7eb]">Date</th>
                  <th scope="col" class="px-6 py-2 text-center text-sm  text-white bg-orange-600  border-collapse border border-[#e5e7eb] ">Time</th>
                  <th scope="col" class="px-6 py-2 text-center text-sm  text-white bg-orange-600   border-collapse border border-[#e5e7eb] ">Venue</th>
              ...
              <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
                {pagination?.paginatedEntities?.map((item, index) => (
                  <tr class="hover:bg-gray-100 dark:hover:bg-gray-700">
                    ...
                    <td class="px-6 py-2.5 whitespace-nowrap text-center  text-xs font-medium text-gray-800 border-collapse border border-[#e5e7eb] hover:text-orange-500 hover:underline"><Link to="/taskform">{item.entity}</Link></td>
                    <td class="px-6 py-2.5 whitespace-nowrap text-center  text-xs font-medium text-gray-800 border-collapse border border-[#e5e7eb]">{item.date}</td>
                    <td class="px-6 py-2.5 whitespace-nowrap text-center  text-xs font-medium text-gray-800 border-collapse border border-[#e5e7eb]">{item.time}</td>
                    <td class="px-6 py-2.5 whitespace-nowrap text-center  text-xs font-medium text-gray-800 border-collapse border border-[#e5e7eb]">{item.venue}</td>
      ...
      <div className="flex justify-end  absolute inset-x-0 bottom-2 item-end px-4 pt-3 pb-2 sm:px-6">
        <section className="isolate inline-flex -space-x-px rounded-md shadow-sm" aria-label="Pagination">
          <button
            ...
            href="#"
            className="relative inline-flex hover:bg-orange-600 hover:text-white items-center rounded-l-md px-2 py-2 text-gray-400 ring-1 ring-inset ring-gray-300 focus:z-20 focus:outline-offset-0"
          >
...
export default CompletedBoardMeetings