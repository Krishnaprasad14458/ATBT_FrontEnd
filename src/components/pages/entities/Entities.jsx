      ...
      <div className='row'>
        <div className='col-12 col-md-6 col-lg-8 col-xl-8'>
          ...
          <div class="relative">
            ...
            <input type="search" id="default-search" class="block w-full px-4 py-2 ps-10 text-sm border border-2 border-gray-400  rounded-2xl bg-gray-50  focus:outline-none focus:border-orange-400 " placeholder="Search here..." required />
          </div>
        </div>
        <div className='col-12 col-md-2 col-lg-2 col-xl-2'> </div>
        <div className='col-12 col-md-2 col-lg-2 col-xl-2 text-sm-end mt-md-1'>
