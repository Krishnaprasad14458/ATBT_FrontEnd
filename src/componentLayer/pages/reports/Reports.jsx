...
let moduleList = [{ label: "User", value: "userId" }, { label: "Entity", value: "entityId" }, { label: "Team", value: "teamId" }]
...
export async function loader({ request, params }) {
  try {
    ...
    const [ReportsMaster, ReportsAtbt, ReportsAtr, Entites] = await Promise.all(
      [
    ...
    let EntitiesList = Entites?.data?.Entites.map((entity) => ({
      label: entity.name,
      value: entity.id,
    }));
